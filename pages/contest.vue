<template>
  <div id="contest">
    <div class="divrow mobile-height" style="height: 600px">
      <div
        class="divcol astart mobile-align"
        style="gap: 35px; min-width: 30% !important"
      >
        <h2
          class="delete-mobile tup"
          style="color: var(--primary); line-height: 60px"
        >
          Music <br />
          Production <br />
          Contest
        </h2>
        <h2 class="show-mobile p tup tcenter" style="color: var(--primary)">
          Music Production Contest
        </h2>
        <span class="tcenter" style="font-size: 16px !important"
          >We are Giving Away Thousands of Dollars in Prizes</span
        >
        <v-btn class="btn" style="--w: 180px" @click="goForm()"
          >Contest Form</v-btn
        >
      </div>
      <div
        class="divrow center margin-mobile-left"
        style="gap: 30px; min-width: 70% !important"
      >
        <div
    ...
    <div class="divcol" style="margin-top: 100px">
      <h2 class="tcenter mb-16">
        WELCOME TO THE MUSIC FEAST MUSIC PRODUCTION CONTEST 2023!
      </h2>
      <p class="p mb-6 mobile-span tcenter" style="margin-inline: 40px">
        We are hosting a worldwide music production contest to find some of the
        dopest producers in the game! <br />
        <br />We are giving away Thousands of dollars in prizes, including a
        Grand Prize of $1000, a mix session with Grammy Award-winning engineer
        Blake Blizzy - whose credits include Kendrick Lamar, and Travis Scott -
        and a track produced by Nailz - whose credits include Eminem, Dr. Dre -
        and much more!<br />
        <br />From September 26th to October 26th, just fill out the SUBMIT FORM
        below and follow the prompts to sign up and enter the contest!<br />
        <br />In addition, the first 100 submissions will be getting a FREE NFT
        of ClassiQ - Generator! We can’t wait to hear what you turn in and keep
        it fresh!<br />
      </p>
    ...
    <div class="container-img-no-margin">
      ...
      <div class="container-text">
        ...
        <span class="mobile-span" style="line-height: 20px; max-width: 60%">
          From September 26th to October 26th (30 days) music producers can
          submit their music to the Music Feast Music Production Contest for a
        ...
        <span class="mobile-span" style="line-height: 20px; max-width: 60%">
          ...
          •2nd Prize: Track Mixed by Grammy Award-Winning Mix Engineer, Blake
          Harden<br />
    ...
    <div class="divcol jstart center" style="gap: 25px">
      ...
      <p class="mobile-span tcenter">
        • Submit your music track demo on or before the deadline date of October
        26th via the SUBMIT FORM below. <br />
        <br />• You will receive a confirmation email of your music submission.
        From this confirmation email, you will share this page and follow our
        socials. Make a social post about this contest and tag us.
      </p>
      <p class="mobile-span tcenter">
        Experiencing issues with Safari? Please use
        <a
          style="font-weight: bold"
          href="https://www.google.com/intl/en_en/chrome/"
          target="_blank"
          >Google Chrome</a
        >
      ...
      <v-col cols="12">
        <section class="card card-icons">
          <v-btn
            v-for="(item, index) in dataSocial"
            :key="index"
            :href="item.link"
            target="_blank"
          >
    ...
    <div id="contest-form" class="form-div" style="margin-top: 40px">
      <div class="max1770">
        ...
        <v-btn
          class="btn mt-4"
          style="--w: 180px; justify-self: center; align-self: center"
          :disabled="disableUpload || validateFile"
          :loading="btnUploadForm"
          @click="uploadForm()"
          >Upload</v-btn
        >
      </div>
    ...
    return {
      ...
      fileRules: [
        ...
        (value) => {
          ...
          const fileExtension = value.name.substring(
        ...
        if (this.$refs.formContest.validate() && this.track_demo) {
          ...
          this.$axios
            ...
            .catch((err) => {
              ...
              this.$alert({
                title: 'ERROR',
                desc: err.response.data.email[0]

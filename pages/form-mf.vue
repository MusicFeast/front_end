<template>
  <div id="form-mf" class="divcol">
    <v-form ref="form" class="grid" @submit.prevent="saveForm()">
      ...
      <section>
        <p>
          Everyone Eats Entertainment would like to first say thank you for your
          interest in the next step in the evolution of the music industry.
        </p>
        <p>
          Our company is a blend of traditional and non traditional music
          industry models. With our technology, you can support your traditional
          releases by building an exclusive, unlockable community that allows
          access to super rare verifiable content and experiences.
        </p>
      </section>
      ...
      >
        <v-btn :ripple="false" class="btn activeBtn" @click="$router.go(-1)"
          >Cancel</v-btn
        >
    ...
    saveForm() {
      ...
      this.$axios
        ...
        .catch((err) => {
          this.$alert({
            title: 'Error!',
            desc: `Data save failed. ${err.message}`,

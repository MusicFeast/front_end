      ...
      <v-col xl="10" lg="9" md="9" sm="8" cols="12">
        <section class="card">
          ...
          <v-select
            ...
            :disabled="showItem || getTier"
            @change="inputSave()"
            class="select tfirst"
            :items="items_tier_update"
    ...
    <section class="card" style="margin-top: 40px">
      ...
      <div class="relative">
        ...
        <v-btn
          ...
          style="top: 20px; right: 40px; position: absolute !important"
          ><v-icon>mdi-minus</v-icon></v-btn
        >
        <v-btn
          class="btn-plus-minus"
          style="top: 20px; right: 0; position: absolute !important"
...
export default {
  ...
  methods: {
    validateTier() {
      const tierFormValue = localStorage.getItem('tier-form')

      if (tierFormValue !== null && tierFormValue === '2') {
        this.selectedTier = 'Tier 2'
        this.getTier = true
      } else if (tierFormValue !== null && tierFormValue === '3') {
        this.selectedTier = 'Tier 3'
        this.getTier = true
      } else if (tierFormValue !== null && tierFormValue === '4') {
        this.selectedTier = 'Tier 4'
        this.getTier = true
      } else if (tierFormValue !== null && tierFormValue === '5') {
        this.selectedTier = 'Tier 5'
        this.getTier = true
      } else if (tierFormValue !== null && tierFormValue === '6') {
        this.selectedTier = 'Tier 6'
        this.getTier = true
      } else if (tierFormValue == null) {

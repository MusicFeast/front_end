<template>
  <div id="community-chat-modals">
    <v-dialog v-model="modalCommunityChat" max-width="500px" content-class="nft-dialog" persistent>
      <v-btn icon class="close" @click="modalCommunityChat = false">
